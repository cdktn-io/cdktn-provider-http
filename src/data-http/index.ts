...
// https://registry.terraform.io/providers/hashicorp/http/3.6.2/docs/data-sources/http
...
export class DataHttp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHttp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/http/3.6.2/docs/data-sources/http#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/http/3.6.2/docs/data-sources/http http} Data Source
  *
  * @param scope The scope in which to define this construct
