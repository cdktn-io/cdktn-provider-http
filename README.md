...
# CDKTN prebuilt bindings for hashicorp/http provider version 3.6.1

This repo builds and publishes the [Terraform http provider](https://registry.terraform.io/providers/hashicorp/http/3.6.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform http provider](https://registry.terraform.io/providers/hashicorp/http/3.6.1)
