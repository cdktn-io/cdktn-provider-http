...
// https://registry.terraform.io/providers/hashicorp/http/3.6.2/docs
...
export class HttpProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing HttpProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/http/3.6.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/http/3.6.2/docs http} Resource
  *
  * @param scope The scope in which to define this construct
